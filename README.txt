...
Добавление действий по-умолчанию:
    Строка начинается со слова 'action' и после пробела любая фраза, описывающая действие крысы
...
# Известные движения крысы (каждое начинается с ключевого слова action
